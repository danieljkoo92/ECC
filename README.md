...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 63 agents, 252 skills, and 79 legacy command shims.
...
**That's it!** You now have access to 63 agents, 252 skills, and 79 legacy command shims.
...
| Skills | PASS: 252 skills    | PASS: 37 skills | **Claude Code leads** |
...
| **Skills** | 252                   | Shared | 10 (native format) | 37 | Via instructions |
